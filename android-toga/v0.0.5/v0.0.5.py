...
# تعیین مسیر فایل لاگ
log_path = "/storage/emulated/0/Download/wwarpscanner/app_python.txt"
...
try:
    ...
    if not os.path.exists(file_path):
            ...
            with open("/storage/emulated/0/Download/wwarpscanner/warp_setting", "w") as f:
                f.write("faster\n")
                f.write("no\n")
                f.write("bpb\n")
                f.write('no\n')
...
class MyApp(toga.App):
    ...
    def startup(self):
        ...
        with open(file_path , "r") as f:
            ...
            if len(num)!=8:
                os.remove("/storage/emulated/0/Download/wwarpscanner/warp_setting")
                with open("/storage/emulated/0/Download/wwarpscanner/warp_setting", "w") as f:
                    f.write("faster\n")
                    f.write("no\n")
                    f.write("bpb\n")
