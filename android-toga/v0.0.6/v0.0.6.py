...
'''
        ...
        ip_box= toga.Box(style=Pack(alignment=LEFT, direction=COLUMN,padding=(5),flex=1))
        ...
        container = toga.OptionContainer(style=Pack(alignment=LEFT,flex=1),
            content=[
        ...
        label_best = toga.TextInput(style=Pack(alignment=LEFT,padding=(10, 20, 10, 20)),placeholder="result:")
